...
### demultiplexing cbcl nova seq 6000
nohup bcl2fastq --runfolder-dir [your_path]/data --output-dir [your_path]/fastq_files --sample-sheet [your_path]/single_cell/data/SampleSheet.csv &
...
#salmon alevin -l ISR -1  Library1_WTA_S1_L001_R1_001.fastq Library1_WTA_S1_L002_R1_001.fastq -2 Library1_WTA_S1_L001_R2_001.fastq Library1_WTA_S1_L002_R2_001.fastq --dropseq  -i /home/otavio/reference_genome/salmon_index -p 10 -o alevin_output --tgMap [your_path]/reference_genome/txp2gene.tsv --dumpFeatures

gunzip *fastq.gz
gffread  -EL Rattus_norvegicus.mRatBN7.2.109.gtf --table @id,@geneid  > txp2gene.tsv

"cart 3"
salmon alevin -l ISR -1  peritoneo_SHAM_S3_L001_R1_001.fastq peritoneo_SHAM_S3_L002_R1_001.fastq -2 peritoneo_SHAM_S3_L001_R2_001.fastq peritoneo_SHAM_S3_L002_R2_001.fastq -i [your_path]/reference_genome/rattus_norvegicus/norvegicus_salmon_index/ --whitelist [your_path]/reference_genome/bd_rhapsody_barcode.txt -p 10 -o norvegius_alevin_output --tgMap [your_path]/reference_genome/rattus_norvegicus/txp2gene.tsv --umi-geometry '1[53-60]' --bc-geometry '1[1-9,22-30,44-52]' --read-geometry '2[1-50q]' --dumpBfh --dumpArborescences --dumpUmiGraph --dumpCellEq --dumpFeatures --dumpMtx

"cart 4"
salmon alevin -l ISR -1  peritoneo_SplancX_S4_L001_R1_001.fastq peritoneo_SplancX_S4_L002_R1_001.fastq -2 peritoneo_SplancX_S4_L001_R2_001.fastq peritoneo_SplancX_S4_L002_R2_001.fastq -i [your_path]/reference_genome/rattus_norvegicus/norvegicus_salmon_index/ --whitelist [your_path]/reference_genome/bd_rhapsody_barcode.txt -p 10 -o norvegius_alevin_output --tgMap [your_path]/reference_genome/rattus_norvegicus/txp2gene.tsv --umi-geometry '1[53-60]' --bc-geometry '1[1-9,22-30,44-52]' --read-geometry '2[1-50]' --dumpBfh --dumpArborescences --dumpUmiGraph --dumpCellEq --dumpFeatures --dumpMtx

"cart 1"
salmon alevin -l ISR -1  spleen-SHAM_S1_L001_R1_001.fastq spleen-SHAM_S1_L002_R1_001.fastq -2 spleen-SHAM_S1_L001_R2_001.fastq spleen-SHAM_S1_L002_R2_001.fastq -i[your_path]/reference_genome/rattus_norvegicus/norvegicus_salmon_index/ --whitelist [your_path]/reference_genome/bd_rhapsody_barcode.txt -p 10 -o norvegius_alevin_output --tgMap [your_path]/reference_genome/rattus_norvegicus/txp2gene.tsv --umi-geometry '1[53-60]' --bc-geometry '1[1-9,22-30,44-52]' --read-geometry '2[1-50]' --dumpBfh --dumpArborescences --dumpUmiGraph --dumpCellEq --dumpFeatures --dumpMtx

"cart 2"
salmon alevin -l ISR -1  spleen-SplancX_S2_L001_R1_001.fastq spleen-SplancX_S2_L002_R1_001.fastq -2 spleen-SplancX_S2_L001_R2_001.fastq spleen-SplancX_S2_L002_R2_001.fastq -i [your_path]/reference_genome/rattus_norvegicus/norvegicus_salmon_index/ --whitelist [your_path]/reference_genome/bd_rhapsody_barcode.txt -p 10 -o norvegius_alevin_output --tgMap [your_path]/reference_genome/rattus_norvegicus/txp2gene.tsv --umi-geometry '1[53-60]' --bc-geometry '1[1-9,22-30,44-52]' --read-geometry '2[1-50]' --dumpBfh --dumpArborescences --dumpUmiGraph --dumpCellEq --dumpFeatures --dumpMtx
